...
x[order(x)]
```
We can arrange this dataset using dplyr
This one arranges them in ascending order so we can see the lowest 5
...
# Q15. Make a first barplot of candy ranking based on winpercent values.
 ...
 Using ggplot: 
 (note: use geom_col over geom_bar most of the time!!)
```{r}
...
```
Also trying plotly to be able to mouse over the plot: 
Note: this worked, but the pdf did not like it!! I have commented it out
